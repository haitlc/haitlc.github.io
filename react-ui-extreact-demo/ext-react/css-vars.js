...
__rt_setDynamic("$accent-color", __rt_getGlobalDefault("$accent_color") || __ColorRGBA.fromHex("#87BD3E"), 11);
...
__rt_setDynamic("$faded-color", __rt_getGlobalDefault("$faded_color") || (__rt_test(__rt_get("$dark_mode")) ? __ColorRGBA.fromHex("#4d4d4d") : __ColorRGBA.fromHex("#e1e1e1")), 34);
